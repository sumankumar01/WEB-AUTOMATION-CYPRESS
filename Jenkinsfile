        ...
        //The steps section defines a series of one or more steps to be executed in a given stage directive.
            steps {
                ...
                /* git ([
                        branch: 'main',
                        changelog: true,
                        credentialsId: '5000b14a-a0d0-4742-955c-75e75a02b26d',
                        poll: false,
                        url: 'https://github.com/sumankumar01/WEB-AUTOMATION-CYPRESS'
                ]) */
            ...
            steps {
                ...
                script {
                    ...
                    if (params.TEST_SPEC == "cypress/e2e/*.js") {
                        ...
                        sh "npm run cy:run --${params.BROWSER_MODE} --browser ${params.BROWSER} --env environmentName=${params.TEST_ENVIRONMENT},grepTags=${params.TAG} ${params.RECORD_TESTS}"
                    } else {
                        echo "Running script: ${params.TEST_SPEC} with Browser: ${params.BROWSER}, TAG: ${params.TAG}, Environment: ${params.TEST_ENVIRONMENT}"
                        sh "npm run cy:run --spec cypress/e2e/tests/${params.TEST_SPEC}.cy.js --${params.BROWSER_MODE} --browser ${params.BROWSER} --env environmentName=${params.TEST_ENVIRONMENT},grepTags=${params.TAG} ${params.RECORD_TESTS}"
                    }
                }
        ...
        always {
           ...
           sh "pwd"
            publishHTML([
                    ...
                    reportName: 'CypressMochawesomeReport',
